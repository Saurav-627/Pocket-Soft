        ...
        <section className="bg-soft-gray py-20 px-6 md:px-12 border-b-4 border-black" id="about">
            <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
                ...
                <div className="flex flex-col gap-8 animate-on-scroll">
                    <span className="tag-oversized w-fit">Identity Report</span>
                    <h2 className="text-5xl font-black">Nepal Origins.<br />Universal Standards.</h2>
                    ...
                    <div className="grid grid-cols-2 gap-8 pt-8">
                        <div className="p-6 bg-white brutalist-border brutalist-shadow-sm">
                            ...
                            <h4 className="font-bold text-lg mb-2">Global Ops</h4>
                        ...
                        <div className="p-6 bg-white brutalist-border brutalist-shadow-sm">
                            ...
                            <h4 className="font-bold text-lg mb-2">Top Tier</h4>
